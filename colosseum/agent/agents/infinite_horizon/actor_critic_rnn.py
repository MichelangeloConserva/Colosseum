...
@gin.configurable
class ActorCriticRNNContinuous(NonTabularBsuiteAgentWrapper):
    """
    ...
    def get_agent_instance_from_parameters(
        ...
        return ActorCriticRNNContinuous(
            seed,
            mdp_specs,
    ...
    def __init__(
        ...
        super(ActorCriticRNNContinuous, self).__init__(seed, agent, mdp_specs)
