...
@gin.configurable
class ActorCriticEpisodic(NonTabularBsuiteAgentWrapper):
    """
    ...
    def produce_gin_file_from_parameters(parameters: Dict[str, Any], index: int = 0):
        ...
        for k, v in parameters.items():
            string += f"prms_{index}/ActorCriticEpisodic.{k} = {v}\n"
        return string[:-1]
    ...
    def __init__(
        ...
        super(ActorCriticEpisodic, self).__init__(seed, agent, mdp_specs)
